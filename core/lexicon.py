...
ASPECT_LEXICON = {
    "food": [
        ...
        "สด", "วัตถุดิบ", "เมนู", "จาน", "ปริมาณ", "ของหวาน", "เครื่องดื่ม",
    ...
    "ambience": [
        ...
        "ตกแต่ง", "เพลง", "เสียงดัง", "ห้องน้ำ", "แสง", "วิว",
        "กว้าง", "แคบ", "โต๊ะ", "เก้าอี้", "สวย", "น่านั่ง", "บรรยากาศดี",
        "ร้าน", "มุม", "ถ่ายรูป", "โทรม", "อึดอัด", "โล่ง",
    ],
    # ความคุ้มค่า/ราคา — แยกออกจาก "อาหาร" เป็นหมวดเอกเทศ
    "value": [
        "ราคา", "คุ้ม", "คุ้มค่า", "แพง", "ไม่คุ้ม", "คุ้มราคา",
        "ราคาถูก", "ราคาแพง", "ค่าอาหาร",
    ],
    # ที่จอดรถ/การเดินทาง — แยกออกจาก "บรรยากาศ" เป็นหมวดเอกเทศ
    "parking": [
        "ที่จอดรถ", "ที่จอด", "จอดรถ", "ลานจอด",
    ],
}
...
ASPECT_NOUNS = {
    "food": {
        ...
        "กับข้าว", "ชิ้น", "คำ", "เครื่องปรุง", "ปลา",
    },
    "service": {
    ...
    "atmosphere": {
        "บรรยากาศ", "แอร์", "ห้องน้ำ", "โต๊ะ", "เก้าอี้", "วิว", "มุม",
        "ร้าน", "เพลง", "แสง", "คน",
    },
    "value": {"ราคา", "ค่าอาหาร", "ค่าใช้จ่าย", "บิล"},
    "parking": {"ที่จอดรถ", "ที่จอด", "ลานจอด", "จอดรถ"},
}
...
DESCRIPTOR_ASPECT_HINTS = {
    ...
    # value-bound descriptors (ราคา/ความคุ้มค่า)
    "แพง": "value", "ถูก": "value", "คุ้ม": "value", "คุ้มค่า": "value",
}
...
# ---------------------------------------------------------------------------
SYNONYM_GROUPS = {
    "price_good": {"label": "ราคาคุ้มค่า", "aspect": "value",
                   "members": {"คุ้มค่า", "ราคาดี", "ราคาไม่แพง", "ราคาเหมาะสม", "ราคาโอเค"}},
    "price_bad":  {"label": "ราคาแพง", "aspect": "value",
