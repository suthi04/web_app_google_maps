...
| `operator_plan` | แผนงานเจ้าของร้านที่รวมประเด็นซ้ำ จัดอันดับจากสัดส่วนและรีวิวไม่ซ้ำ พร้อมวิธีตรวจผลรอบถัดไป |
...
มีชุดทดสอบ **293 เทสต์** (ใช้ `unittest` ใน standard library — ไม่ต้องติดตั้ง pytest):
