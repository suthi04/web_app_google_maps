...
- **แยก "การสกัด" ออกจาก "การตัดสินอารมณ์":** อารมณ์ของแต่ละวลีตัดสิน **ตามบริบทอนุประโยค**
  (เช่น `คนเยอะ` อาจเป็นบวกหรือลบขึ้นกับบริบท) ไม่ใช่จากตัววลีลำพัง
...
- ความครอบคลุมของวลีจำกัดด้วย **ขนาดพจนานุกรม** — คำที่ไม่อยู่ใน `lexicon.py` อาจหลุด
  (วิธีปรับปรุง: เพิ่มคำใน `core/lexicon.py`)
